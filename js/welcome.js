...
$.ajax({
    ...
    data: {
        key: 'HTPBZ-J66WT-HXLXK-VRQQO-DFRG7-JOBDD',
        output: 'jsonp',
    },
    dataType: 'jsonp',
...
function showWelcome() {
    ...
    let dist = getDistance(111.31745732773396, 30.72357810537885, ipLocation.result.location.lng, ipLocation.result.location.lat); //这里记得换成自己的经纬度
